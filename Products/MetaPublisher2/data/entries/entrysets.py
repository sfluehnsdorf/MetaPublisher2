...
class EntrySets:
    ...
    def get_entryset(
        self, source, field_ids=None, parent_entry_id=None, entry_ids=None,
        ...
        entry_ids
            the unique ids identifying the Entries. If specified,
            entry_positions must be None or a ValueError exception will be
            raised.

        entry_positions
            the position identifying the Entries. If specified, entry_ids must
        ...
        order_by
            one or more Field id to order on or order expression used to sort
            the Entries.

        offset
            the index of the first Entry to return from the total result set.
            Must be an integer greater or equal to zero.

        limit
            the maxinum number of Entries to return. Must be an integer greater
            or equal to zero.

        bound
            if True, the returned EntrySet is bound to the source, referencing
            the origin of the Entries in the EntrySet.

        lazy
            if True, Entries and EntryFields are loaded from the source as
            needed. The EntrySet must be bound for lazy retrieval.
        ...
        return source.get_entryset(
            ...
            order_by, offset, limit, bound, live)

    security.declareProtected(permission_access_entries, 'join_entries')

    def join_entries(
        self, left_source, right_source, join_type='inner',
        join_conditions=None, field_ids=None, parent_entry_id=None,
        entry_ids=None, entry_positions=None, conditions=None, order_by=None,
        offset=None, limit=None, left_field_ids=None,
        left_parent_entry_id=None, left_entry_ids=[], left_entry_positions=[],
        left_conditions=None, left_order_by=None, left_offset=None,
        left_limit=None, right_field_ids=None, right_parent_entry_id=None,
        right_entry_ids=[], right_entry_positions=[], right_conditions=None,
        right_order_by=None, right_offset=None, right_limit=None, bound=true,
        lazy=true, live=True
    ):
        """
        ...
        left_source
            the id of a Storage, a Storage or an EntrySet to retrieve the
            Entries from for the left side of the join.

        right_source
            the id of a Storage, a Storage or an EntrySet to retrieve the
            Entries from for the right side of the join.
        ...
        field_ids
            ...
            the Field's id by a period, for example 'mystorage.id' or 'left.id'
        ...
        offset
        limit
            modifiers for the resulting Entries. See get_entryset() for
            details.
        ...
        return source.join_entries(
            ...
            offset, limit, left_field_ids, left_parent_entry_id,
            left_entry_ids, left_entry_positions, left_conditions,
            left_order_by, left_offset, left_limit, right_field_ids,
            right_parent_entry_id, right_entry_ids, right_entry_positions,
            right_conditions, right_order_by, right_offset, right_limit, bound,
            lazy, live)
    ...
    def select_entries(
        self, source, fields=None, joins=None, conditions=None, order_by=None,
        ...
        A Field id can be prefixed with a source Storage's id or a source's
    ...
    def is_member(
        ...
        entry
          an Entry or a mapping that must contain at least the Fields tested
          for in the specified source.
        ...
        field_ids
          ...
          the Field in the Entry with the first item and the Field in the
          source with the second item, mapping the two differently named Fields
          to each other. Instead of a Field id an expression may be defined. If
    ...
    def is_disjoint(
        self, source, other_source, field_ids=None, parent_entry_id=None,
        entry_ids=None, entry_positions=None, conditions=None,
        ...
        return source.is_disjoint(
            other_source, field_ids, parent_entry_id, entry_ids,
            entry_positions, conditions, other_field_ids,
            other_parent_entry_id, other_entry_ids, other_entry_positions,
            other_conditions)
    ...
    security.declareProtected(
        permission_change_entries, 'symmetric_difference')
