...
from Products.MetaPublisher2.library.common import (
    ClassSecurityInfo, ComputedAttribute, DTMLFile, false, InitializeClass,
    true)
...
class LegacyStoragePlugin(LegacyPluginBase, StoragePluginBase):
    ...
    def all_meta_types(self, interfaces=None):
        ...
        for product in Products.meta_types:
            if (
                product.get('visibility', None) == 'ZMP2FieldPlugin' and
                product not in result
            ):
    ...
    def storage_getEntryFields(self, entry_ids, field_id, default=None):
        ...
        return map(
            lambda id: (id, get_entryfield(id, field_id, default)),
            entryIds)
