...
$Id: publisher/frontends/frontends.py 15 2013-05-05 18:02:09Z sfluehnsdorf $
"""
...
class Frontends:
    ...
    def frontendplugin_items(self):
        """Return tuples of id, value of installed MetaPublisher2 Frontend plugins"""
    ...
    def get_frontendflag(self, frontend_path, pluginflag_id):
        """Return the boolean state of the specified Frontend flag if it exists, raises KeyError otherwise"""
    ...
    def get_frontend_rendering_ids(self, path):
        """Return a list of all ids generated by rendering the specified Frontend."""
    ...
    def add_frontend_type(self, REQUEST=None):
        """Add a new Frontend in the specified path with specified id and configuration."""
