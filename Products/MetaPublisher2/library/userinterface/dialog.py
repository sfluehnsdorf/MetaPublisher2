...
class Dialog:
    ...
    not_available_dialog = DTMLFile('dialog', globals(),
    ...
    designsfolder_warning_dialog = DTMLFile('dialog', globals(),
        headline=u'''Warning!''',
    ...
    frontendsfolder_warning_dialog = DTMLFile('dialog', globals(),
        headline=u'''Warning!''',
    ...
    languagesfolder_warning_dialog = DTMLFile('dialog', globals(),
        headline=u'''Warning!''',
    ...
    toolsfolder_warning_dialog = DTMLFile('dialog', globals(),
        headline=u'''Warning!''',
    ...
    widgetsfolder_warning_dialog = DTMLFile('dialog', globals(),
        headline=u'''Warning!''',
    ...
    no_entries_dialog = DTMLFile('dialog', globals(),
    ...
    no_storages_dialog = DTMLFile('dialog', globals(),
    ...
    no_fields_dialog = DTMLFile('dialog', globals(),
    ...
    no_frontends_dialog = DTMLFile('dialog', globals(),
    ...
    no_widgets_dialog = DTMLFile('dialog', globals(),
    ...
    no_designs_dialog = DTMLFile('dialog', globals(),
    ...
    no_plugins_dialog = DTMLFile('dialog', globals(),
    ...
    no_storageplugins_dialog = DTMLFile('dialog', globals(),
    ...
    no_fieldplugins_dialog = DTMLFile('dialog', globals(),
    ...
    no_frontendplugins_dialog = DTMLFile('dialog', globals(),
    ...
    no_widgetplugins_dialog = DTMLFile('dialog', globals(),
    ...
    no_designplugins_dialog = DTMLFile('dialog', globals(),
