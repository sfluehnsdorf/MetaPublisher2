...
from Products.MetaPublisher2.library.common import Folder
...
class MetaEntries(Folder):
    ...
    def all_meta_types(self):
        """Return valid meta_types for this container."""
...
class MetaZopeStorage(StoragePlugin):
    ...
    manage_configureStorageForm = DTMLFile(
        'dtml/editMetaZopeStorage', globals())
    ...
    def storage_entryIds(
        self, order_by=None, reverse=False, filters=None, start=0, end=None,
        limit=None
    ):
        """Return ids of Entries of this Storage."""
        return self.entries.objectIds()

    def storage_entryItems(
        self, order_by=None, reverse=False, filters=None, start=0, end=None,
        limit=None
    ):
